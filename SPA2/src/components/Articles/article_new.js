...
class ArticleNew extends Component {
	...
	onSubmit(values){
		...
		this.props.postNewArticle(values, token)//,() => { this.props.history.push("/user")});
	}
	...
	render() {
		...
		<div>
			...
			<form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
				...
				<Field name="Image" label="Obrázek" component={this.renderArticleImageField} type="file" value={null} />
				<Field name="Game" label="Hra" component={this.renderArticleGameSelectField}/>
				<button type="submit" className="btn btn-primary">Publikovat</button>
			</form>
		</div>);
...
export default reduxForm({
	// validate,
	form: "NewArticleForm"
})(connect(mapStateToProps, {postNewArticle})(ArticleNew));
